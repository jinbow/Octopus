...
if (maxval(abs(uvw)) >4 .or. abs(xyz(ip,3,IPP))>Nz+2 ) then
   print*, 'particle velocity',uvw
   print*, 'particle positions',xyz(ip,:,IPP)
   stop "particle velocity exceeds 4m/s. It is obviously wrong somewhere. This error message is generated by get_velocity.f90"
endif
